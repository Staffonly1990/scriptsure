...
interface IAddRespiratory {
  sendForm(d: {}): void;
}
const AddVitalFormRespiratory: FC<IAddRespiratory> = observer(({ sendForm }) => {
    ...
    <div className="p-4 shadow-md">
      ...
      >
        ...
        <div className="flex flex-col m-2">
          ...
          >
            {intl.formatMessage({
              id: 'vital.measures.respiratory.enterRate',
            })}
          </label>
          <MaskInput
            ...
            // onBlur={() => toggleIsFocusInput(false)}
...
AddVitalFormRespiratory.displayName = 'AddVitalFormRespiratory';
export default AddVitalFormRespiratory;
