...
const SettingsPracticeAddUsersModal: FC<IModalAddUsers> = observer(({ isCheckedPrescribers }) => {
  const intl = useIntl();

  const [checkedUsers, setCheckedUsers] = useState<Partial<IUser>[]>([]);
  ...
  return (
    ...
    >
      <Button type="submit" className="uppercase" shape="smooth" color="white" variant="flat">
...
SettingsPracticeAddUsersModal.displayName = 'SettingsPracticeAddUsersModal';
export default SettingsPracticeAddUsersModal;
