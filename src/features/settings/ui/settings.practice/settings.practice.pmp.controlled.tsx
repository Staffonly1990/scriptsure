...
/**
 * @view SettingsPracticeOmpControlled
 */
const SettingsPracticePmpControlled: FC = observer(() => {
  const intl = useIntl();
  ...
  return (
    <SettingsForm
      settings={[
        {
          title: intl.formatMessage({ id: 'settings.pmpControlled' }),
...
SettingsPracticePmpControlled.displayName = 'SettingsPracticePmpControlled';

export default SettingsPracticePmpControlled;
