...
const PharmacyRequestGenericSubstitution: FC = observer(() => {
  ...
  return (
    <div className="flex flex-col">
      <span className="mb-[25px] font-medium text-xl">Pharmacist would like to substitute the prescribed medication with a generic equivalent</span>
...
PharmacyRequestGenericSubstitution.displayName = 'PharmacyRequestGenericSubstitution';
export default PharmacyRequestGenericSubstitution;
