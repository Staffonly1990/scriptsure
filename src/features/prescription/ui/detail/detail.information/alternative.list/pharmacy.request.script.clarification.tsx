...
const PharmacyRequestScriptClarification: FC = observer(() => {
  return (
...
PharmacyRequestScriptClarification.displayName = 'PharmacyRequestScriptClarification';
export default PharmacyRequestScriptClarification;
